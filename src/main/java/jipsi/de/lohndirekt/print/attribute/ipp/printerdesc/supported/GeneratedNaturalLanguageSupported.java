...
public class GeneratedNaturalLanguageSupported extends TextSyntax implements SupportedValuesAttribute {

	/**
	 * @param value
	 */
	public GeneratedNaturalLanguageSupported(String name, Locale locale) {
		super(name, locale);
	}
