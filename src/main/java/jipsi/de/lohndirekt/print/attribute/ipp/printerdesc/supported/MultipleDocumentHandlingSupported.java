...
public class MultipleDocumentHandlingSupported extends TextSyntax implements SupportedValuesAttribute {

	/**
	 * @param value
	 */
	public MultipleDocumentHandlingSupported(String value, Locale locale) {
		super(value, locale);
	}
