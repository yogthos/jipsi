...
public class MultipleDocumentHandlingDefault extends TextSyntax implements DefaultAttribute {

	/**
	 * @param value
	 */
	public MultipleDocumentHandlingDefault(String value, Locale locale) {
		super(value, locale);
	}
